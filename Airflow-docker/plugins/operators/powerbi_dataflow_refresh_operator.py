...
class PowerBIDataflowRefreshOperator(BaseOperator):
    ...
    """
    template_fields = ('dataflow_id', 'token')
    ...
    def __init__(
        ...
        # powerbi_conn_id: str = 'powerbi_conn',
        *args, **kwargs
    ):
        """
    ...
    def _get_refresh_status(self):
        ...
        base_url = f'https://api.powerbi.com/{self.api_version}/myorg/'
        endpoint_url = f'{base_url}datasets/{self.dataflow_id}/{self.refresh_endpoint}'
